    ...
    <div style={{ backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      <div style={{ textAlign: 'center', padding: '0 20px 40px 20px' }}>
        ...
        <p style={{
          ...
          라온아띠 키즈 독채 펜션에서 편안하고 프라이빗한 휴식을 경험하세요. 
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: '#666', lineHeight: 1.5 }}>
                라온아띠는 1,2층의 독채 풀빌라이며며 100평의 넓은 공간으로 충분한 여유 공간을 제공합니다.
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: '#666', lineHeight: 1.5 }}>
                전용 마당과 수영장이 있어 야외 활동과 휴식에 최적입니다.
              </p>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: '#666', lineHeight: 1.5 }}>
                2개의 침실, 넓은 거실, 완비된 주방, 전용 바베큐 공간, 노래방, 키즈 플레이룸, 오락기 등을 갖추고 있습니다.
              </p>
            </div>
